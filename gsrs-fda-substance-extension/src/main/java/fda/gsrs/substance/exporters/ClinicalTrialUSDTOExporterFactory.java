...
public class ClinicalTrialUSDTOExporterFactory implements ExporterFactory {
	...
	@Override
	public ClinicalTrialUSDTOExporter createNewExporter(OutputStream out, Parameters params) throws IOException {
		...
		ClinicalTrialUSDTOExporter.Builder builder = new ClinicalTrialUSDTOExporter.Builder(spreadsheet);
		configure(builder, params);
		
		return builder.build(substanceEntityService);
	}

	protected void configure(ClinicalTrialUSDTOExporter.Builder builder, Parameters params) {
