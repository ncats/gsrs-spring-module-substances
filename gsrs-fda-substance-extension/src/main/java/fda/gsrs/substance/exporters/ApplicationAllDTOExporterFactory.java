...
public class ApplicationAllDTOExporterFactory implements ExporterFactory {
	...
	@Override
	public ApplicationAllDTOExporter createNewExporter(OutputStream out, Parameters params) throws IOException {
	...
	protected void configure(ApplicationAllDTOExporter.Builder builder, Parameters params) {
