./mvnw install:install-file -Dfile=extraJars/applications-api-3.1.4-SNAPSHOT.jar
./mvnw install:install-file -Dfile=extraJars/products-api-3.1.4-SNAPSHOT.jar
