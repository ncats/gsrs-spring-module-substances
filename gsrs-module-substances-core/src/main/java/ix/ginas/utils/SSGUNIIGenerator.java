...
public class SSGUNIIGenerator extends RandomAlphaNumericIDGenerator<Substance> {
	...
	public SSGUNIIGenerator(){
		super(alphabet,idLen,true);
	}


	@Override
	public boolean allowID(String ignore, String s) {
		/*
	...
	public boolean isValidId(String id) {
		return this.valid(id) && this.allowID(id, id);
	}
