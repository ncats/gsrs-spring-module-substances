...
@Entity
@Table(name="ix_ginas_relationship", indexes = {@Index(name = "interaction_index", columnList = "interaction_type"),
		...
		@Index(name = "relationship_owner_index", columnList = "owner_uuid")})
@SingleParent
