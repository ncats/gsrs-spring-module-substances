...
/**
 * A wrapper around the PrintStream used to STDOUT and STDERR
 * so we can filter out some classes print statements.
 *
 * Unfortunately, not all GSRS code or its dependencies
 * use loggers to print data but sometimes write directly
 * to STDOUT or STDERR which can clog our GSRS logs
 * so this is a hacky way to hide such statements.
 *
